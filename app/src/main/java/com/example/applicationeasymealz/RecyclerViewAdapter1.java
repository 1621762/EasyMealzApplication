...
public class RecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerViewAdapter1.MyHolder> {
    ...
    public RecyclerViewAdapter1(Context mContext, List<Recipes> mData){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = layoutInflater.inflate(R.layout.chicken_cardview_recipe,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        ...
        myHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext,Recipe1Activity.class);
