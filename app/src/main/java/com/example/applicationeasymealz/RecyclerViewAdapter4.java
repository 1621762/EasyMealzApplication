...
public class RecyclerViewAdapter4 extends RecyclerView.Adapter<RecyclerViewAdapter4.MyHolder> {

    private Context mContext;
    private List<Recipes> mData;

    public RecyclerViewAdapter4(Context mContext, List<Recipes> mData){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = layoutInflater.inflate(R.layout.lamb_cardview_recipe,viewGroup,false);
