...
public class RecyclerViewAdapter5 extends RecyclerView.Adapter<RecyclerViewAdapter5.MyHolder> {

    private Context mContext;
    private List<Recipes> mData;

    public RecyclerViewAdapter5(Context mContext, List<Recipes> mData){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = layoutInflater.inflate(R.layout.lactose_cardview_recipe,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        ...
        myHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext,Recipe2Activity.class);
